...
class Args(Tap):
    ...
    use_image_adapter: int = 0         # use image adapter or not
    image_folder: str = None           # image folder
    condition_folder: str = None        # condition folder
    pretrained_path: str = None        # pretrained path
    adapter_pretrained_path: str = None # adapter pretrained path 
    ...
    eval_vae_path: str = None
    eval_vae_config: str = None
