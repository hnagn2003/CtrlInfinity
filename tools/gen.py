...
if des_ver == "1":
    from infinity.models.infinity1 import Infinity
    print(" >>>>>>>>>>>>>>>> using version 1")  
elif des_ver == "2":
    from infinity.models.infinity2 import Infinity
    print(" >>>>>>>>>>>>>>>> using version 2")
elif des_ver == "3":
    from infinity.models.infinity3 import Infinity
    print(" >>>>>>>>>>>>>>>> using version 3")
elif des_ver == "4":
    from infinity.models.infinity4 import Infinity
    ...
    with torch.cuda.amp.autocast(enabled=True, dtype=torch.bfloat16, cache_enabled=True), torch.no_grad():
        ...
        if checkpoint_type == 'torch':
            ...
            if base_model is not None:
                state_dict = torch.load(base_model, map_location='cpu')
...
def add_common_arguments(parser):
    ...
    parser.add_argument('--use_image_adapter', type=int, default=0, choices=[0,1])
    parser.add_argument('--condition_folder', type=str, default='')
